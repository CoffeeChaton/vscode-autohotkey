...
export const statement2Data: TStatement2Element[] = [
    {
        ...
        doc: 'Checks whether a [variable\'s](https://www.autohotkey.com/docs/Variables.htm) contents are numerically or alphabetically between two values (inclusive).',
    ...
    },
    {
        ...
        doc: 'Checks whether a [variable\'s](https://www.autohotkey.com/docs/Variables.htm) contents match one of the items in a list.',
